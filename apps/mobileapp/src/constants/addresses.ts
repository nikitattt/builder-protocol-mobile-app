...
export const MERKLE_RESERVE_MINTER = {
  [CHAIN_ID.ETHEREUM]:
    '0x0000000000000000000000000000000000000000' as AddressType,
  [CHAIN_ID.OPTIMISM]:
    '0x8DFEd5737cd21e25009A2a2CB56dca8EA618e5D3' as AddressType,
  [CHAIN_ID.SEPOLIA]:
    '0x0000000000000000000000000000000000000000' as AddressType,
  [CHAIN_ID.OPTIMISM_SEPOLIA]:
  ...
  [CHAIN_ID.BASE_SEPOLIA]:
    '0x7AbE363C6DD3a4dEC6a3311681723f35740f69E7' as AddressType,
...
export const L2_MIGRATION_DEPLOYER = {
  [CHAIN_ID.ETHEREUM]:
    '0x0000000000000000000000000000000000000000' as AddressType,
  [CHAIN_ID.OPTIMISM]:
    '0x7D8Ea0D056f5B8443cdD8495D4e90FFCf0a8A354' as AddressType,
  [CHAIN_ID.SEPOLIA]:
    '0x0000000000000000000000000000000000000000' as AddressType,
  [CHAIN_ID.OPTIMISM_SEPOLIA]:
  ...
  [CHAIN_ID.BASE_SEPOLIA]:
    '0x1e57Cad7C22042BD765011d0F2eb36606Fe12C3F' as AddressType,
...
export const MERKLE_METADATA_RENDERER = {
  [CHAIN_ID.ETHEREUM]:
    '0x0000000000000000000000000000000000000000' as AddressType,
  [CHAIN_ID.OPTIMISM]:
    '0xdEe7aa9B8d084541Fe2c71c52217Fbc2b14d922D' as AddressType,
  [CHAIN_ID.SEPOLIA]:
    '0x0000000000000000000000000000000000000000' as AddressType,
  [CHAIN_ID.OPTIMISM_SEPOLIA]:
  ...
  [CHAIN_ID.BASE_SEPOLIA]:
    '0x4E5979Fc762c3b1BB63C6FC467141Ef2BF2140bA' as AddressType,
...
export const L1_CROSS_DOMAIN_MESSENGER = {
  ...
  [CHAIN_ID.SEPOLIA]:
    '0x0000000000000000000000000000000000000000' as AddressType,
  [CHAIN_ID.OPTIMISM]:
    '0x25ace71c97B33Cc4729CF772ae268934F7ab5fA1' as AddressType,
  [CHAIN_ID.OPTIMISM_SEPOLIA]:
  ...
  [CHAIN_ID.ZORA_SEPOLIA]:
    '0x1bDBC0ae22bEc0c2f08B4dd836944b3E28fe9b7A' as AddressType,
  [CHAIN_ID.BASE]: '0x866E82a600A1414e583f7F13623F1aC5d58b0Afa' as AddressType,
  [CHAIN_ID.BASE_SEPOLIA]:
    '0xC34855F4De64F1840e5686e64278da901e261f20' as AddressType,
  [CHAIN_ID.FOUNDRY]:
    '0x0000000000000000000000000000000000000000' as AddressType
}
